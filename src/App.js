    ...
    <UserContext.Provider value={user_data}>
      <Router>
        ...
        <Routes>
          ...
          {/* protected routes */}
          <Route path='/checkout' element={<PrivateRoute Component={BillingInformation} />} />
          <Route path='/wishlist' element={<PrivateRoute Component={MyWishList} />} />
          <Route path='/cart' element={<PrivateRoute Component={MyShoppingCart} />} />
          <Route path='/create_account' element={<PrivateRoute Component={Create_Acct} />} />
          <Route path='/error_404' element={<PrivateRoute Component={Error_Page} />} />
          <Route path='/empty_cart' element={<PrivateRoute Component={Empty_Cart} />} />
          <Route path='/settings' element={<PrivateRoute Component={User_Settings} />} />
          <Route path='/dashboard' element={<PrivateRoute Component={User_Dashboard} />} />
          <Route path='/confirm_order' element={<PrivateRoute Component={Order_Confirm} />} />
          <Route path='/testing' element={<PrivateRoute Component={Testing} />} />
          <Route path='/order-detail/:orderId' element={<PrivateRoute Component={Order_Detail} />} />
          <Route path='/order-history' element={<PrivateRoute Component={OrderHistory} />} />
          <Route path='/billing-address' element={<PrivateRoute Component={Billing_address} />} />
          <Route path='/testing' element={<PrivateRoute Component={Testing} />} />
        </Routes>
        <Footer />
      </Router>
