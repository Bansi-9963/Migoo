...
const MyShoppingCart = () => {
  ...
  const renderMobileItems = () => {
    return Data.map((product, index) => {
      const matchingItem = productDetail.find(
        item => product.product_id === item.id
      )
        ...
        return (
          <MyShoppingCartMobile
            ...
            image={
              ...
              matchingItem.images[0].original
            }
        ...
        <div className='grid grid-cols-12 gap-6 mt-6 '>
          <div className='relative overflow-x-auto mt-4 rounded-md  lg:col-span-8 col-span-12 border border-gray-100 ssm:block hidden'>
            ...
            <div className='flex flex-row px-6 '>
              <button className='px-8 py-3.5  rounded-full bg-gray-50 text-gray-300 font-semibold my-4 text-[#4f4f4f]'>
                Return To Shop
              </button>
            </div>
          </div>
          <div className=' max-h-[290px] bg-white border-t border-gray-100 py-3 px-6 leading-6 lg:mt-4 ssm:px-6 ssm:rounded-md ssm:border ssm:border-gray-100 lg:col-span-4 col-span-12'>
            ...
            {/* <Link to='/checkout'> */}
            <button
              className='px-8 lg:py-3.5 py-2 my-3 text-white rounded-full bg-[#E6992A] font-semibold w-full'
