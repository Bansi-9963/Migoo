...
<div className="relative rounded-lg overflow-hidden shadow-sm sm:w-[100%] w-[100%] bg-white mb-2 flex">
   ...
   <div className="px-[14px] pt-8 pb-[9px] w-[60%]">
      <div className="flex mb-2 justify-between">
         <div className="text-gray-900 sm:text-lg text-base font-semibold leading-6 w-[104px]">{text}</div>
      ...
      <div className="flex justify-between items-center mb-2">
         <span className={`py-1 px-2 rounded-md ${isOutOfStock ? 'bg-red-600 bg-opacity-20 text-branding-error' : 'bg-yellow-300 bg-opacity-20 text-branding-success-dark'} text-sm font-normal leading-5`}>
         {status}
         </span>
      </div>
      <div className={`px-4 md:px-8 py-2.5 btn text-white rounded-full flex justify-center ${isOutOfStock ? 'bg-[#F2F2F2] font-semibold' : 'bg-[#E6992A] font-semibold'} lg:hidden block`}>
