...
<div className="relative rounded-lg overflow-hidden shadow-sm sm:w-[100%] w-[100%] bg-white mb-2 flex">
   ...
   <div className="px-[14px] pt-4 pb-[9px]">
      <div className="flex mb-2 justify-between">
         <div className="text-gray-900 text-lg font-semibold leading-6 w-[104px]">{text}</div>
      </div>
      ...
      <div className={`px-4 md:px-8 py-3.5 btn text-white rounded-full flex justify-center ${isOutOfStock ? 'bg-[#F2F2F2] font-semibold' : 'bg-[#E6992A] font-semibold'} lg:hidden block`}>
