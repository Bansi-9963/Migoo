...
const Header = () => {
  ...
  return (
    <header
      className='relative bg-white z-10 h-[83px] md:h-auto'
      id='header_nav'
    >
      ...
      <div className='h-[60px] lg:flex items-center hidden container-1 justify-between'>
        <div className='flex xl:h-[21px] items-center gap-8'>
          ...
          <div>
            <a className='font-medium leading-[21px] text-sm flex mt-[3px] cursor-pointer'>
              Shop
        ...
        <div className='flex gap-2 items-center'>
          <div>
            ...
            >
              <path
                d='M14.4355 2.375C15.9189 2.77396 17.2714 3.55567 18.3576 4.64184C19.4438 5.72801 20.2255 7.08051 20.6244 8.56388'
                stroke='#1A1A1A'
                strokeWidth='1.5'
                strokeLinecap='round'
                strokeLinejoin='round'
              />
              <path
                d='M13.5303 5.75684C14.4201 5.99622 15.2314 6.46518 15.883 7.11675C16.5345 7.76832 17.0035 8.57964 17.2429 9.46946'
                stroke='#1A1A1A'
                strokeWidth='1.5'
                strokeLinecap='round'
                strokeLinejoin='round'
          ...
          <div className='text-[#1A1A1A] font-medium text-sm cursor-pointer'>
            (219) 555-0114
          </div>
        </div>
      </div>
      ...
      >
        <div className='container-1'>
          ...
          <div className='w-full flex justify-between items-center border-b-[1px]'>
            <p className='text-xl pt-3 pb-3 cursor-pointer'>Shop</p>
            <div className='mr-2'>
              <svg
                width='18'
                height='18'
          ...
          <div className='w-full flex justify-between items-center border-b-[1px]'>
            <p className='text-xl pt-3 pb-3 cursor-pointer'>Pages</p>
            <div className='mr-2'>
              <svg
                width='18'
                height='18'
          ...
          <div className='border-b-[1px]'>
            <p className='text-xl pt-3 pb-3 cursor-pointer'>Contact Us</p>
          </div>
        </div>
      </div>
      {/* user icon dashboard */}
      ...
      >
        <div className='container-1'>
          <div className='border-b-[1px] flex items-center gap-3'>
            ...
            <p className='text-xl pt-3 pb-3 cursor-pointer'>Dashboard</p>
          </div>
          <div className='border-b-[1px] flex items-center gap-3'>
            <p>
              <img src={order_history} className='w-5 h-5' />
            </p>
            <p className='text-xl pt-3 pb-3 cursor-pointer'>Order History</p>
          </div>
          <div className='border-b-[1px] flex items-center gap-3'>
            <p>
              <img src={Wishlist} className='w-5 h-5' />
            </p>
            <p className='text-xl pt-3 pb-3 cursor-pointer'>Wishlist</p>
          </div>
          <div className='border-b-[1px] flex items-center gap-3'>
            <p>
              <img src={ShoppingList} className='w-5 h-5' />
            </p>
            <p className='text-xl pt-3 pb-3 cursor-pointer'>Shopping List</p>
          </div>
          <div className='border-b-[1px] flex items-center gap-3'>
            <p>
              <img src={Settings} className='w-5 h-5' />
            </p>
            <p className='text-xl pt-3 pb-3 cursor-pointer'>Settings</p>
          </div>
          <div className='border-b-[1px] flex items-center gap-3'>
            <p>
              <img src={Logout} className='w-5 h-5' />
            </p>
            <p className='text-xl pt-3 pb-3 cursor-pointer'>Log-Out</p>
          </div>
        </div>
      </div>
    </header>
