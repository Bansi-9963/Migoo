  ...
  return (
    <div className="xl:h-[463px] lg:h-[400px] 2xl:w-[312px] xl:w-[300px] lg:w-[270px] rounded-lg border-[1px] border-[#E6E6E6] sticky top-[120px]">
      <ul>
        ...
        <Link to="/dashboard">
          <li
            className={`pl-[23px] h-[56px] flex items-center hover:bg-[#F2F0ED] hover:border-l-[3px] hover: border-[#E6992A] transition duration-300 ${location.pathname === "/dashboard"
        ...
        <Link to="/order-history">
          <li
            className={`pl-[23px] h-[56px] flex items-center hover:bg-[#F2F0ED] hover:border-l-[3px] hover: border-[#E6992A] transition duration-300 ${location.pathname === "/order-history"
              ? "bg-[#F2F0ED] border-l-[3px] border-[#E6992A]"
              : ""
              }`}
          >
        ...
        <li
          className={`pl-[23px] h-[56px] flex items-center hover:bg-[#F2F0ED] hover:border-l-[3px] hover: border-[#E6992A] transition duration-300 ${location.pathname === "/wishlist"
            ? "bg-[#F2F0ED] border-l-[3px] border-[#E6992A]"
            : ""
            }`}
        >
        ...
        <Link to="/settings">
          <li
            className={`pl-[23px] h-[56px] flex items-center  hover:bg-[#F2F0ED] hover:border-l-[3px] hover: border-[#E6992A] transition duration-300 ${location.pathname === "/settings"
              ? "bg-[#F2F0ED] border-l-[3px] border-[#E6992A]"
              : ""
              }`}
          >
        ...
        <Link to="/billing-address">
          <li
            className={`pl-[23px] h-[56px] flex items-center hover:bg-[#F2F0ED] hover:border-l-[3px] hover: border-[#E6992A] transition duration-300 ${location.pathname === "/billing-address"
              ? "bg-[#F2F0ED] border-l-[3px] border-[#E6992A]"
              : ""
              }`}
          >
