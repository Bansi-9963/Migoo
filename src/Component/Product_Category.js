...
const Product_Category = () => {
  ...
  const handleChange = (event) => {
    ...
    let matching_labels = [...labels].filter((data) => data.htmlFor === event.target.value);
    if (matching_labels.length > 0 && event.target.checked === true) {
      ...
      setData(initial_data => {
        let new_data = [...initial_data.filter((data) => data.brand === event.target.defaultValue)]
        return new_data
      })
    } else {
  ...
  return (
    <div className='container-1'>
      ...
      <div id='breadcrumbs' className='lg:h-[62px] h-11 w-full flex items-center gap-[10px]'>
        ...
        <div className='pt-1'>
          <p className='text-[#E6992A] font-medium text-base'>Categories</p>
        </div>
      </div>
      ...
      <div className='xl:mt-6 lg:mt-5 mt-4 mb-20'>
        {/* Filter button */}
        <div className='flex items-center justify-center gap-3 bg-[#E6992A] rounded-[43px] pt-3 pb-3 w-[131px] lg:pointer-events-none cursor-pointer' onClick={handleFilter}>
          <div>
        ...
        <div className='hidden mt-3' id='filter_div'>
          <div className='px-1 py-1'>
            <div className='flex justify-between'>
              <div>
                <p className='text-[#1A1A1A] text-xl font-medium'>All Categories</p>
              </div>
              <div id='mobile_cat_arrow' onClick={() => handleCat("mob_cat_div", "mobile_cat_arrow")}>
                <svg width="16" height="16" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M1.33268 1.6665L5.99935 6.33317L10.666 1.6665" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
            </div>
          </div>
          <div id='mob_cat_div' className='hidden px-1'>
            <div className='flex flex-col'>
              <div className='flex justify-between'>
                ...
                <div className='flex justify-center items-center cursor-pointer' id='mob_right_arrow_1' onClick={() => handleArrow("mob_sub_cat1", "mob_right_arrow_1")}>
                  <svg width="16" height="16" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M1.33268 1.6665L5.99935 6.33317L10.666 1.6665" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
            ...
            <div className='flex flex-col'>
              <div className='flex justify-between'>
                ...
                <div className='flex justify-center items-center cursor-pointer' id='mob_right_arrow_2' onClick={() => handleArrow("mob_sub_cat2", "mob_right_arrow_2")}>
                  <svg width="16" height="16" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M1.33268 1.6665L5.99935 6.33317L10.666 1.6665" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
            ...
            <div className='flex flex-col'>
              <div className='flex justify-between'>
                ...
                <div className='flex justify-center items-center cursor-pointer' id='mob_right_arrow_3' onClick={() => handleArrow("mob_sub_cat3", "mob_right_arrow_3")}>
                  <svg width="16" height="16" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M1.33268 1.6665L5.99935 6.33317L10.666 1.6665" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
          ...
          <div className='px-1 py-1'>
            <div className='flex justify-between'>
              ...
              <div id='mobile_cat_arrow' onClick={() => handleCat("mob_double_slider_price_range", "mobile_cat_arrow")}>
                <svg width="16" height="16" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M1.33268 1.6665L5.99935 6.33317L10.666 1.6665" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
          ...
          <div id='mob_double_slider_price_range' className='mt-2 h-20 hidden border-b-[1px]'>
            <div className='px-1'>
              <div className={'values'}>Price : ₹{values[0]} - ₹{values[1]}</div>
              <SLider className="slider w-full h-1 bg-[white] mt-[22px]" value={values} min={MIN} max={MAX} onChange={setValues} />
            </div>
          </div>
          <div className='px-1 py-1'>
            ...
            <div id='brands_list' className='mt-1 mb-2'>
              <div className='w-full flex justify-between items-center'>
                <label className='text-[#4D4D4D] font-medium text-[18px]' htmlFor="mob_brand_1">Brand 1</label>
                <input type='checkbox' id='brand_id' value="mob_brand_1" onChange={handleChange1} />
              </div>
              <div className='w-full flex justify-between items-center'>
                <label className='text-[#4D4D4D] font-medium text-[18px]' htmlFor="mob_brand_2">Brand 2</label>
                <input type='checkbox' id='brand_id' value="mob_brand_2" onChange={handleChange1} />
              </div>
              <div className='w-full flex justify-between items-center'>
                <label className='text-[#4D4D4D] font-medium text-[18px]' htmlFor="mob_brand_3">Brand 3</label>
                <input type='checkbox' id='brand_id' value="mob_brand_3" onChange={handleChange1} />
              </div>
              <div className='w-full flex justify-between items-center'>
                <label className='text-[#4D4D4D] font-medium text-[18px]' htmlFor="mob_brand_4">Brand 4</label>
                <input type='checkbox' id='brand_id' value="mob_brand_4" onChange={handleChange1} />
              </div>
              <div className='w-full flex justify-between items-center'>
                <label className='text-[#4D4D4D] font-medium text-[18px]' htmlFor="mob_brand_5">Brand 5</label>
                <input type='checkbox' id='brand_id' value="mob_brand_5" onChange={handleChange1} />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className='flex 2xl:gap-[33px] xl:gap-7 lg:gap-5'>
          <div className='2xl:w-[312px] xl:w-[272px] lg:w-[252px] h-fit mt-5 sticky top-[100px] hidden lg:block'>
            ...
            <div className='flex justify-between items-center h-10 hover:bg-[#e9e7e1] hover:rounded w-full'>
              <div>
                <p className='text-xl font-medium text-[#1A1A1A] px-1'>All Categories</p>
              </div>
              <div id='all_cat_down' className='cursor-pointer px-1' onClick={() => handleCat("category_div", "all_cat_down")}>
                <svg width="16" height="16" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M1.33268 1.6665L5.99935 6.33317L10.666 1.6665" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
            ...
            <div id='category_div' className='hidden px-1 py-2 border-b-[1px]'>
              <div className='flex flex-col'>
                <div className='flex justify-between'>
                  ...
                  <div className='flex justify-center items-center cursor-pointer' id='right_arrow_1' onClick={() => handleArrow("sub_cat1", "right_arrow_1")}>
                    <svg width="16" height="16" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M1.33268 1.6665L5.99935 6.33317L10.666 1.6665" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  </div>
              ...
              <div className='flex flex-col'>
                <div className='flex justify-between'>
                  ...
                  <div className='flex justify-center items-center cursor-pointer' id='right_arrow_2' onClick={() => handleArrow("sub_cat2", "right_arrow_2")}>
                    <svg width="16" height="16" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M1.33268 1.6665L5.99935 6.33317L10.666 1.6665" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  </div>
              ...
              <div className='flex flex-col'>
                <div className='flex justify-between'>
                  ...
                  <div className='flex justify-center items-center cursor-pointer' id='right_arrow_3' onClick={() => handleArrow("sub_cat3", "right_arrow_3")}>
                    <svg width="16" height="16" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M1.33268 1.6665L5.99935 6.33317L10.666 1.6665" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  </div>
            ...
            <div className='flex justify-between items-center h-10 hover:bg-[#e9e7e1] hover:rounded w-full'>
              ...
              <div id='price_down' className='cursor-pointer px-1' onClick={() => handleCat("double_slider_price_range", "price_down")}>
                <svg width="16" height="16" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M1.33268 1.6665L5.99935 6.33317L10.666 1.6665" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
            ...
            {/* Price Range */}
            <div id='double_slider_price_range' className='mt-2 h-20 hidden border-b-[1px]'>
              <div className='px-1'>
                <div className={'values'}>Price : ₹{values[0]} - ₹{values[1]}</div>
                <SLider className="slider w-full h-1 bg-[white] mt-[22px]" value={values} min={MIN} max={MAX} onChange={setValues} />
              </div>
            ...
            <div className='px-1'>
              ...
              <div id='brands_list' className='mt-1 mb-2'>
                <div className='w-full flex justify-between items-center'>
                  <label className='text-[#4D4D4D] font-medium text-[18px]' htmlFor="brand_1">Brand 1</label>
                  <input type='checkbox' id='brand_id' value="brand_1" onChange={handleChange} />
                </div>
                <div className='w-full flex justify-between items-center'>
                  <label className='text-[#4D4D4D] font-medium text-[18px]' htmlFor="brand_2">Brand 2</label>
                  <input type='checkbox' id='brand_id' value="brand_2" onChange={handleChange} />
                </div>
                <div className='w-full flex justify-between items-center'>
                  <label className='text-[#4D4D4D] font-medium text-[18px]' htmlFor="brand_3">Brand 3</label>
                  <input type='checkbox' id='brand_id' value="brand_3" onChange={handleChange} />
                </div>
                <div className='w-full flex justify-between items-center'>
                  <label className='text-[#4D4D4D] font-medium text-[18px]' htmlFor="brand_4">Brand 4</label>
                  <input type='checkbox' id='brand_id' value="brand_4" onChange={handleChange} />
                </div>
                <div className='w-full flex justify-between items-center'>
                  <label className='text-[#4D4D4D] font-medium text-[18px]' htmlFor="brand_5">Brand 5</label>
                  <input type='checkbox' id='brand_id' value="brand_5" onChange={handleChange} />
                </div>
              </div>
            </div>
          </div>
          <div className='flex flex-col 2xl:w-[975px] w-full h-fit pt-5'>
            {/* Categories Imgaes */}
            <div className='grid 2xl:grid-cols-4 md:grid-cols-3 ssm:grid-cols-2 grid-cols-1 w-full h-auto 2xl:gap-[25px] xl:gap-5 lg:gap-4 md:gap-5 ssm:gap-3 gap-5'>
            ...
            <div className="pagination-buttons w-full flex justify-center pt-8">
              ...
              >
                <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M20.9167 12.1668L15.0834 18.0002L20.9167 23.8335" stroke={` ${currentPage <= 1 ? "#B3B3B3" : "#1A1A1A"}`} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </button>
              ...
              >
                <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <rect x="-0.5" y="0.5" width="35" height="35" rx="17.5" transform="matrix(-1 0 0 1 35 0)" stroke="#E6E6E6" />
                  <path d="M15.0833 12.1668L20.9166 18.0002L15.0833 23.8335" stroke={` ${currentPage >= totalPages ? "#B3B3B3" : "#1A1A1A"}`} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
