...
const Searchbycategorycard = ({ name, imageUrl, imagetitle, imagetext }) => {
  return (
    <Link to={`/product_category/${name}`}>
      <div className='relative overflow-hidden shadow-md shadow-gray-400 hover:cursor-pointer  bg-white  xl:w-full md:w-[220px] msm:w-[250px] ssm:w-[200px]  max-[475px]:w-[250px] mx-auto transition-transform transform hover:scale-105 hover:shadow-[#b6b6b6] hover:shadow-lg'>
