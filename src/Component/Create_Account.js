      ...
      >
        ...
        <div className="2xl:h-[208px] 2xl:w-[472px] mt-[20px]">
          ...
          <div className="relative">
            ...
            <img src={eye} className="absolute top-[25px] right-[16px]" id='eye_1' onClick={() => handleEye("password-input", "eye_1")} />
          </div>
          ...
          <div className="relative">
            <input
              ...
              className="w-full h-[49px] rounded-md border-[1px] border-[#E6E6E6] md:px-[16px] px-[14px] md:py-[14px] py-3 text-base leading-[20.8px] font-normal mt-[12px] focus:outline-[#E6992A]"
            />
            <img src={eye} className="absolute top-[25px] right-[16px]" id='eye_2' onClick={() => handleEye("confirm_password-input", "eye_2")} />
          </div>
          ...
          <button className="w-full h-[45px] rounded-[43px] bg-[#E6992A] hover:bg-[#af8345ee] transition duration-300 md:mt-5 ssm:mt-4 mt-3 flex justify-center items-center text-white font-semibold text-[14px] leading-[16.8px]">
            Create Account
          </button>
